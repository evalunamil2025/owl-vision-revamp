        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {whyUs.map((item, i) => (
            <motion.div
              ...
              className="group relative bg-white p-10 rounded-[2.5rem] border border-[#015093]/5 shadow-[0_30px_60px_-15px_rgba(1,80,147,0.05)] hover:shadow-[0_40px_80px_-15px_rgba(0,166,81,0.1)] transition-all duration-500 flex flex-col items-center text-center"
            >
              ...
              <div className="mb-8 relative flex justify-center">
                ...
                {/* Punto decorativo */}
                <div className="absolute -top-1 -right-1 w-3 h-3 bg-[#00a651]/20 rounded-full blur-sm opacity-0 group-hover:opacity-100 transition-opacity" />
              </div>
              ...
              <p className="text-sm text-[#015093]/60 font-body leading-relaxed">{item.desc}</p>
            </motion.div>
          ))}
        </div>
