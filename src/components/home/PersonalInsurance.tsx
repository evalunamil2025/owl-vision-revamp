...
const PersonalInsurance = () => {
  // Definimos los tipos explícitamente para evitar el error de TypeScript
  ...
  const itemVariants: Variants = {
    ...
    visible: {
      ...
      transition: {
        duration: 0.6,
        ease: [0.22, 1, 0.36, 1], // Usamos una curva Bézier específica (equivalente a easeOut) para evitar el error de string
      },
    },
  };
      ...
      <div className="container mx-auto max-w-7xl px-4">
        ...
        >
          {personalServices.map((s, i) => (
            ...
            >
              {/* Borde inferior con Glow Animado */}
