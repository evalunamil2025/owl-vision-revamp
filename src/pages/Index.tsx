...
import {
  ArrowRight, Phone, Shield, Users, Handshake, HeartHandshake,
...
const personalServices = [
  ...
  { icon: ShieldCheck, label: "Renters Insurance", href: "/renters-insurance", desc: "Your belongings deserve protection." },
...
const businessServices = [
  ...
  { icon: Sparkles, label: "Restaurant Insurance", href: "/restaurant-insurance", desc: "Specialized restaurant coverage." },
