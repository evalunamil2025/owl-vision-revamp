    ...
    <section className="gradient-navy text-primary-foreground section-padding relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl relative z-10 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <h1 className="text-4xl sm:text-5xl font-heading font-extrabold mb-4 text-white">About Bringas Insurance Group</h1>
    ...
    <section className="section-padding">
      <div className="container mx-auto max-w-5xl">
        <div className="grid md:grid-cols-2 gap-12 items-center mb-16">
          <div>
            <div className="flex items-center gap-2 mb-3">
              <div className="icon-circle-sm"><Eye className="w-5 h-5" strokeWidth={1.8} /></div>
              <span className="text-sm font-heading font-bold text-secondary uppercase tracking-wider">Our Vision</span>
            </div>
            <h2 className="text-3xl font-heading font-extrabold mb-4">Financial peace shouldn't be an empty promise</h2>
        ...
        <div className="grid sm:grid-cols-3 gap-6 mb-16">
          {[
            ...
            <motion.div key={i} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="elevated-card p-6 text-center group">
              <div className="icon-circle mx-auto mb-4 group-hover:scale-110 transition-transform duration-300"><item.icon className="w-6 h-6" strokeWidth={1.8} /></div>
        ...
        <div className="elevated-card p-8 border-l-4 border-l-secondary">
          <h2 className="text-2xl font-heading font-extrabold mb-4">Our Team</h2>
