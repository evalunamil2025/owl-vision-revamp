...
import personalUmbrellaImage from "@/assets/service-personal-umbrella.webp";
import serviceRentersImage from "@/assets/service-renters.webp";
import serviceLandlordImage from "@/assets/service-landlord.webp";
import serviceAutoImage from "@/assets/service-auto.webp";
import serviceHomeImage from "@/assets/service-home.webp";
import owlieAutoIcon from "@/assets/owlie-auto-icon.webp";
import owlieAutoIconWhite from "@/assets/owlie-auto-icon-white.png";
import owlieHomeIcon from "@/assets/owlie-home-icon.webp";
import owlieHomeIconWhite from "@/assets/owlie-home-icon-white.png";
import owlieLifeIcon from "@/assets/owlie-life-icon.webp";
import owlieLifeIconWhite from "@/assets/owlie-life-icon-white.png";
import owlieFloodIcon from "@/assets/owlie-flood-icon.webp";
...
import owlieGeneralLiabilityIcon from "@/assets/owlie-generalLiability-icon.webp";
import owlieGeneralLiabilityIconWhite from "@/assets/owlie-generalLiability-icon-white.png";
import owlieBopIcon from "@/assets/owlie-bop-icon.webp";
...
import owlieCommercialPropertyIcon from "@/assets/owlie-commercialProperty-icon.webp";
import owlieCommercialPropertyIconWhite from "@/assets/owlie-commercialProperty-icon-white.png";
import owlieContractorsIcon from "@/assets/owlie-contractors-icon.webp";
import owlieContractorsIconWhite from "@/assets/owlie-contractors-icon-white.png";
import owlieRestaurantIcon from "@/assets/owlie-restaurant-icon.webp";
import owlieRestaurantIconWhite from "@/assets/owlie-restaurant-icon-white.png";
import owlieBuildingOwnersIcon from "@/assets/owlie-buildingOwners-icon.webp";
import owlieBuildingOwnersIconWhite from "@/assets/owlie-buildingOwners-icon-white.png";
import owlieBondsSuretyIcon from "@/assets/owlie-bondsSurety-icon.webp";
